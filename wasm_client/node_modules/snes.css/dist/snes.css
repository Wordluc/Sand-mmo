/*!*******************************************************************************************************************************************************************************!*\
  !*** css ./node_modules/css-loader/dist/cjs.js!./node_modules/postcss-loader/dist/cjs.js??ruleSet[1].rules[2].use[2]!./node_modules/sass-loader/dist/cjs.js!./scss/snes.scss ***!
  \*******************************************************************************************************************************************************************************/
@import url(https://fonts.googleapis.com/css2?family=Press+Start+2P&display=swap);
/*!***********************************************************************************************************************************************************************************!*\
  !*** css ./node_modules/css-loader/dist/cjs.js!./node_modules/postcss-loader/dist/cjs.js??ruleSet[1].rules[2].use[2]!./node_modules/sass-loader/dist/cjs.js!./scss/snes.scss (1) ***!
  \***********************************************************************************************************************************************************************************/
...
.snes-container::before, .snes-container::after {
  content: "";
  position: absolute;
  display: block;
  z-index: 0;
...
.snes-container::before {
  ...
  left: calc(0% - 6px);
  top: calc(100% - (6px));
  -webkit-clip-path: polygon(0 calc(6px * 2), calc(100% - 6px * 2) calc(6px * 2), calc(100% - 6px * 2) 6px, calc(100% - 6px) 6px, calc(100% - 6px) 0, 100% 0, 100% calc(6px * 2), calc(100% - 6px) calc(6px * 2), calc(100% - 6px) 100%, 0 100%);
          clip-path: polygon(0 calc(6px * 2), calc(100% - 6px * 2) calc(6px * 2), calc(100% - 6px * 2) 6px, calc(100% - 6px) 6px, calc(100% - 6px) 0, 100% 0, 100% calc(6px * 2), calc(100% - 6px) calc(6px * 2), calc(100% - 6px) 100%, 0 100%);
}
...
.snes-link::after {
  ...
  top: 100%;
  left: 0;
  transition: width 0.4s cubic-bezier(0.075, 0.82, 0.165, 1) 0s;
}
...
.snes-input:has(select)::before {
  color: #9b5de5;
  right: calc(0% + 15 * 1.3333333333px);
  top: calc(50% - 11 * 2px);
  margin: 9px 13px;
  content: "";
  width: 2px;
  height: 2px;
  box-shadow: 2px 2px #000000,4px 2px #000000,26px 2px #000000,28px 2px #000000,2px 4px #000000,4px 4px color-mix(in srgb, currentColor, white 35%),6px 4px #000000,24px 4px #000000,26px 4px color-mix(in srgb, currentColor, black 15%),28px 4px #000000,2px 6px #000000,4px 6px color-mix(in srgb, currentColor, white 15%),6px 6px color-mix(in srgb, currentColor, white 35%),8px 6px #000000,22px 6px #000000,24px 6px color-mix(in srgb, currentColor, black 15%),26px 6px currentColor,28px 6px #000000,2px 8px #000000,4px 8px color-mix(in srgb, currentColor, white 15%),6px 8px color-mix(in srgb, currentColor, white 15%),8px 8px color-mix(in srgb, currentColor, white 35%),10px 8px #000000,20px 8px #000000,22px 8px color-mix(in srgb, currentColor, black 15%),24px 8px currentColor,26px 8px currentColor,28px 8px #000000,2px 10px #000000,4px 10px color-mix(in srgb, currentColor, black 10%),6px 10px color-mix(in srgb, currentColor, white 15%),8px 10px color-mix(in srgb, currentColor, white 15%),10px 10px color-mix(in srgb, currentColor, white 35%),12px 10px #000000,18px 10px #000000,20px 10px color-mix(in srgb, currentColor, black 15%),22px 10px currentColor,24px 10px currentColor,26px 10px color-mix(in srgb, currentColor, black 35%),28px 10px #000000,4px 12px #000000,6px 12px color-mix(in srgb, currentColor, black 10%),8px 12px color-mix(in srgb, currentColor, white 15%),10px 12px color-mix(in srgb, currentColor, white 15%),12px 12px color-mix(in srgb, currentColor, white 35%),14px 12px #000000,16px 12px #000000,18px 12px color-mix(in srgb, currentColor, black 15%),20px 12px currentColor,22px 12px currentColor,24px 12px color-mix(in srgb, currentColor, black 35%),26px 12px #000000,6px 14px #000000,8px 14px color-mix(in srgb, currentColor, black 10%),10px 14px color-mix(in srgb, currentColor, white 15%),12px 14px color-mix(in srgb, currentColor, white 15%),14px 14px color-mix(in srgb, currentColor, white 35%),16px 14px color-mix(in srgb, currentColor, black 15%),18px 14px currentColor,20px 14px currentColor,22px 14px color-mix(in srgb, currentColor, black 35%),24px 14px #000000,8px 16px #000000,10px 16px color-mix(in srgb, currentColor, black 10%),12px 16px color-mix(in srgb, currentColor, white 15%),14px 16px color-mix(in srgb, currentColor, white 15%),16px 16px currentColor,18px 16px currentColor,20px 16px color-mix(in srgb, currentColor, black 35%),22px 16px #000000,10px 18px #000000,12px 18px color-mix(in srgb, currentColor, black 10%),14px 18px color-mix(in srgb, currentColor, white 15%),16px 18px currentColor,18px 18px color-mix(in srgb, currentColor, black 35%),20px 18px #000000,12px 20px #000000,14px 20px color-mix(in srgb, currentColor, black 10%),16px 20px color-mix(in srgb, currentColor, black 35%),18px 20px #000000,14px 22px #000000,16px 22px #000000;;
}
...
.snes-input:has(input, textarea).is-error::before {
  right: calc(0% + 17 * 1.3333333333px);
  top: calc(50% - 17 * 2px);
  margin: 15px 15px;
  content: "";
  width: 2px;
  height: 2px;
  box-shadow: 12px 2px #000000,14px 2px #000000,16px 2px #000000,18px 2px #000000,20px 2px #000000,22px 2px #000000,24px 2px #000000,8px 4px #000000,10px 4px #000000,12px 4px color-mix(in srgb, #f22561, white 55%),14px 4px color-mix(in srgb, #f22561, white 55%),16px 4px color-mix(in srgb, #f22561, white 55%),18px 4px color-mix(in srgb, #f22561, white 55%),20px 4px #f22561,22px 4px color-mix(in srgb, #f22561, white 55%),24px 4px #f22561,26px 4px #000000,28px 4px #000000,6px 6px #000000,8px 6px color-mix(in srgb, #f22561, white 55%),10px 6px color-mix(in srgb, #f22561, white 55%),12px 6px #f22561,14px 6px #f22561,16px 6px #f22561,18px 6px #f22561,20px 6px #f22561,22px 6px #f22561,24px 6px #f22561,26px 6px #f22561,28px 6px #f22561,30px 6px #000000,4px 8px #000000,6px 8px color-mix(in srgb, #f22561, white 55%),8px 8px #f22561,10px 8px #f22561,12px 8px #f22561,14px 8px #f22561,16px 8px #f22561,18px 8px #f22561,20px 8px #f22561,22px 8px #f22561,24px 8px #f22561,26px 8px #f22561,28px 8px #f22561,30px 8px #f22561,32px 8px #000000,4px 10px #000000,6px 10px color-mix(in srgb, #f22561, white 55%),8px 10px #f22561,10px 10px #f22561,12px 10px #f22561,14px 10px #f22561,16px 10px #f22561,18px 10px #f22561,20px 10px #f22561,22px 10px #f22561,24px 10px #f22561,26px 10px #f22561,28px 10px #f22561,30px 10px #f22561,32px 10px #000000,2px 12px #000000,4px 12px color-mix(in srgb, #f22561, white 55%),6px 12px #f22561,8px 12px #f22561,10px 12px #ffffff,12px 12px #ffffff,14px 12px #ffffff,16px 12px #f22561,18px 12px #f22561,20px 12px #f22561,22px 12px #ffffff,24px 12px #ffffff,26px 12px #ffffff,28px 12px #f22561,30px 12px #f22561,32px 12px #f22561,34px 12px #000000,2px 14px #000000,4px 14px color-mix(in srgb, #f22561, white 55%),6px 14px #f22561,8px 14px #f22561,10px 14px #f22561,12px 14px #ffffff,14px 14px #ffffff,16px 14px #ffffff,18px 14px #f22561,20px 14px #ffffff,22px 14px #ffffff,24px 14px #ffffff,26px 14px #f22561,28px 14px #f22561,30px 14px #f22561,32px 14px color-mix(in srgb, #f22561, black 50%),34px 14px #000000,2px 16px #000000,4px 16px color-mix(in srgb, #f22561, white 55%),6px 16px #f22561,8px 16px #f22561,10px 16px #f22561,12px 16px #f22561,14px 16px #ffffff,16px 16px #ffffff,18px 16px #ffffff,20px 16px #ffffff,22px 16px #ffffff,24px 16px #f22561,26px 16px #f22561,28px 16px #f22561,30px 16px #f22561,32px 16px #f22561,34px 16px #000000,2px 18px #000000,4px 18px color-mix(in srgb, #f22561, white 55%),6px 18px #f22561,8px 18px #f22561,10px 18px #f22561,12px 18px #f22561,14px 18px #f22561,16px 18px #ffffff,18px 18px #ffffff,20px 18px #ffffff,22px 18px #f22561,24px 18px #f22561,26px 18px #f22561,28px 18px #f22561,30px 18px #f22561,32px 18px color-mix(in srgb, #f22561, black 50%),34px 18px #000000,2px 20px #000000,4px 20px #f22561,6px 20px #f22561,8px 20px #f22561,10px 20px #f22561,12px 20px #f22561,14px 20px #f22561,16px 20px #ffffff,18px 20px #ffffff,20px 20px #ffffff,22px 20px #f22561,24px 20px #f22561,26px 20px #f22561,28px 20px #f22561,30px 20px #f22561,32px 20px color-mix(in srgb, #f22561, black 50%),34px 20px #000000,2px 22px #000000,4px 22px color-mix(in srgb, #f22561, white 55%),6px 22px #f22561,8px 22px #f22561,10px 22px #f22561,12px 22px #f22561,14px 22px #ffffff,16px 22px #ffffff,18px 22px #ffffff,20px 22px #ffffff,22px 22px #ffffff,24px 22px #f22561,26px 22px #f22561,28px 22px #f22561,30px 22px #f22561,32px 22px color-mix(in srgb, #f22561, black 50%),34px 22px #000000,2px 24px #000000,4px 24px #f22561,6px 24px #f22561,8px 24px #f22561,10px 24px #f22561,12px 24px #ffffff,14px 24px #ffffff,16px 24px #ffffff,18px 24px #f22561,20px 24px #ffffff,22px 24px #ffffff,24px 24px #ffffff,26px 24px #f22561,28px 24px #f22561,30px 24px #f22561,32px 24px color-mix(in srgb, #f22561, black 50%),34px 24px #000000,4px 26px #000000,6px 26px #f22561,8px 26px #f22561,10px 26px #ffffff,12px 26px #ffffff,14px 26px #ffffff,16px 26px #f22561,18px 26px #f22561,20px 26px #f22561,22px 26px #ffffff,24px 26px #ffffff,26px 26px #ffffff,28px 26px #f22561,30px 26px color-mix(in srgb, #f22561, black 50%),32px 26px #000000,4px 28px #000000,6px 28px #f22561,8px 28px #f22561,10px 28px #f22561,12px 28px #f22561,14px 28px #f22561,16px 28px #f22561,18px 28px #f22561,20px 28px #f22561,22px 28px #f22561,24px 28px #f22561,26px 28px #f22561,28px 28px #f22561,30px 28px color-mix(in srgb, #f22561, black 50%),32px 28px #000000,6px 30px #000000,8px 30px #f22561,10px 30px #f22561,12px 30px #f22561,14px 30px #f22561,16px 30px #f22561,18px 30px #f22561,20px 30px #f22561,22px 30px #f22561,24px 30px #f22561,26px 30px color-mix(in srgb, #f22561, black 50%),28px 30px color-mix(in srgb, #f22561, black 50%),30px 30px #000000,8px 32px #000000,10px 32px #000000,12px 32px #f22561,14px 32px color-mix(in srgb, #f22561, black 50%),16px 32px #f22561,18px 32px color-mix(in srgb, #f22561, black 50%),20px 32px color-mix(in srgb, #f22561, black 50%),22px 32px color-mix(in srgb, #f22561, black 50%),24px 32px color-mix(in srgb, #f22561, black 50%),26px 32px #000000,28px 32px #000000,12px 34px #000000,14px 34px #000000,16px 34px #000000,18px 34px #000000,20px 34px #000000,22px 34px #000000,24px 34px #000000;;
}
.snes-input:has(input, textarea).is-success::before {
  ...
  width: 2px;
  height: 2px;
  box-shadow: 12px 2px #000000,14px 2px #000000,16px 2px #000000,18px 2px #000000,20px 2px #000000,22px 2px #000000,24px 2px #000000,8px 4px #000000,10px 4px #000000,12px 4px color-mix(in srgb, #4bb244, white 55%),14px 4px color-mix(in srgb, #4bb244, white 55%),16px 4px color-mix(in srgb, #4bb244, white 55%),18px 4px color-mix(in srgb, #4bb244, white 55%),20px 4px #4bb244,22px 4px color-mix(in srgb, #4bb244, white 55%),24px 4px #4bb244,26px 4px #000000,28px 4px #000000,6px 6px #000000,8px 6px color-mix(in srgb, #4bb244, white 55%),10px 6px color-mix(in srgb, #4bb244, white 55%),12px 6px #4bb244,14px 6px #4bb244,16px 6px #4bb244,18px 6px #4bb244,20px 6px #4bb244,22px 6px #4bb244,24px 6px #4bb244,26px 6px #4bb244,28px 6px #4bb244,30px 6px #000000,4px 8px #000000,6px 8px color-mix(in srgb, #4bb244, white 55%),8px 8px #4bb244,10px 8px #4bb244,12px 8px #4bb244,14px 8px #4bb244,16px 8px #4bb244,18px 8px #4bb244,20px 8px #4bb244,22px 8px #4bb244,24px 8px #4bb244,26px 8px #4bb244,28px 8px #4bb244,30px 8px #4bb244,32px 8px #000000,4px 10px #000000,6px 10px color-mix(in srgb, #4bb244, white 55%),8px 10px #4bb244,10px 10px #4bb244,12px 10px #4bb244,14px 10px #4bb244,16px 10px #4bb244,18px 10px #4bb244,20px 10px #4bb244,22px 10px #4bb244,24px 10px #4bb244,26px 10px #4bb244,28px 10px #4bb244,30px 10px #4bb244,32px 10px #000000,2px 12px #000000,4px 12px color-mix(in srgb, #4bb244, white 55%),6px 12px #4bb244,8px 12px #4bb244,10px 12px #4bb244,12px 12px #4bb244,14px 12px #4bb244,16px 12px #4bb244,18px 12px #4bb244,20px 12px #4bb244,22px 12px #4bb244,24px 12px #ffffff,26px 12px #ffffff,28px 12px #ffffff,30px 12px #4bb244,32px 12px #4bb244,34px 12px #000000,2px 14px #000000,4px 14px color-mix(in srgb, #4bb244, white 55%),6px 14px #4bb244,8px 14px #4bb244,10px 14px #4bb244,12px 14px #4bb244,14px 14px #4bb244,16px 14px #4bb244,18px 14px #4bb244,20px 14px #4bb244,22px 14px #ffffff,24px 14px #ffffff,26px 14px #ffffff,28px 14px #ffffff,30px 14px #4bb244,32px 14px color-mix(in srgb, #4bb244, black 50%),34px 14px #000000,2px 16px #000000,4px 16px color-mix(in srgb, #4bb244, white 55%),6px 16px #4bb244,8px 16px #ffffff,10px 16px #ffffff,12px 16px #4bb244,14px 16px #4bb244,16px 16px #4bb244,18px 16px #4bb244,20px 16px #ffffff,22px 16px #ffffff,24px 16px #ffffff,26px 16px #ffffff,28px 16px #4bb244,30px 16px #4bb244,32px 16px #4bb244,34px 16px #000000,2px 18px #000000,4px 18px color-mix(in srgb, #4bb244, white 55%),6px 18px #4bb244,8px 18px #ffffff,10px 18px #ffffff,12px 18px #ffffff,14px 18px #4bb244,16px 18px #4bb244,18px 18px #ffffff,20px 18px #ffffff,22px 18px #ffffff,24px 18px #ffffff,26px 18px #4bb244,28px 18px #4bb244,30px 18px #4bb244,32px 18px color-mix(in srgb, #4bb244, black 50%),34px 18px #000000,2px 20px #000000,4px 20px #4bb244,6px 20px #4bb244,8px 20px #ffffff,10px 20px #ffffff,12px 20px #ffffff,14px 20px #ffffff,16px 20px #ffffff,18px 20px #ffffff,20px 20px #ffffff,22px 20px #ffffff,24px 20px #4bb244,26px 20px #4bb244,28px 20px #4bb244,30px 20px #4bb244,32px 20px color-mix(in srgb, #4bb244, black 50%),34px 20px #000000,2px 22px #000000,4px 22px color-mix(in srgb, #4bb244, white 55%),6px 22px #4bb244,8px 22px #4bb244,10px 22px #ffffff,12px 22px #ffffff,14px 22px #ffffff,16px 22px #ffffff,18px 22px #ffffff,20px 22px #ffffff,22px 22px #4bb244,24px 22px #4bb244,26px 22px #4bb244,28px 22px #4bb244,30px 22px #4bb244,32px 22px color-mix(in srgb, #4bb244, black 50%),34px 22px #000000,2px 24px #000000,4px 24px #4bb244,6px 24px #4bb244,8px 24px #4bb244,10px 24px #4bb244,12px 24px #ffffff,14px 24px #ffffff,16px 24px #ffffff,18px 24px #ffffff,20px 24px #4bb244,22px 24px #4bb244,24px 24px #4bb244,26px 24px #4bb244,28px 24px #4bb244,30px 24px #4bb244,32px 24px color-mix(in srgb, #4bb244, black 50%),34px 24px #000000,4px 26px #000000,6px 26px #4bb244,8px 26px #4bb244,10px 26px #4bb244,12px 26px #4bb244,14px 26px #ffffff,16px 26px #ffffff,18px 26px #4bb244,20px 26px #4bb244,22px 26px #4bb244,24px 26px #4bb244,26px 26px #4bb244,28px 26px #4bb244,30px 26px color-mix(in srgb, #4bb244, black 50%),32px 26px #000000,4px 28px #000000,6px 28px #4bb244,8px 28px #4bb244,10px 28px #4bb244,12px 28px #4bb244,14px 28px #4bb244,16px 28px #4bb244,18px 28px #4bb244,20px 28px #4bb244,22px 28px #4bb244,24px 28px #4bb244,26px 28px #4bb244,28px 28px #4bb244,30px 28px color-mix(in srgb, #4bb244, black 50%),32px 28px #000000,6px 30px #000000,8px 30px #4bb244,10px 30px #4bb244,12px 30px #4bb244,14px 30px #4bb244,16px 30px #4bb244,18px 30px #4bb244,20px 30px #4bb244,22px 30px #4bb244,24px 30px #4bb244,26px 30px color-mix(in srgb, #4bb244, black 50%),28px 30px color-mix(in srgb, #4bb244, black 50%),30px 30px #000000,8px 32px #000000,10px 32px #000000,12px 32px #4bb244,14px 32px color-mix(in srgb, #4bb244, black 50%),16px 32px #4bb244,18px 32px color-mix(in srgb, #4bb244, black 50%),20px 32px color-mix(in srgb, #4bb244, black 50%),22px 32px color-mix(in srgb, #4bb244, black 50%),24px 32px color-mix(in srgb, #4bb244, black 50%),26px 32px #000000,28px 32px #000000,12px 34px #000000,14px 34px #000000,16px 34px #000000,18px 34px #000000,20px 34px #000000,22px 34px #000000,24px 34px #000000;;
}
.snes-input:has(input, textarea).is-warning::before {
  right: calc(0% + 16 * 1.3333333333px);
  top: calc(50% - 16 * 2px);
  margin: 14px 14px;
  content: "";
  width: 2px;
  height: 2px;
  box-shadow: 16px 2px #000000,18px 2px #000000,14px 4px #000000,16px 4px color-mix(in srgb, #f2c019, white 55%),18px 4px #ff6f00,20px 4px #000000,14px 6px #000000,16px 6px color-mix(in srgb, #f2c019, white 55%),18px 6px #ff6f00,20px 6px #000000,12px 8px #000000,14px 8px color-mix(in srgb, #f2c019, white 55%),16px 8px #f2c019,18px 8px #f2c019,20px 8px #ff6f00,22px 8px #000000,12px 10px #000000,14px 10px color-mix(in srgb, #f2c019, white 55%),16px 10px #f2c019,18px 10px #f2c019,20px 10px #ff6f00,22px 10px #000000,10px 12px #000000,12px 12px color-mix(in srgb, #f2c019, white 55%),14px 12px #f2c019,16px 12px #000000,18px 12px #000000,20px 12px #f2c019,22px 12px #ff6f00,24px 12px #000000,10px 14px #000000,12px 14px color-mix(in srgb, #f2c019, white 55%),14px 14px #f2c019,16px 14px #000000,18px 14px #000000,20px 14px #f2c019,22px 14px #ff6f00,24px 14px #000000,8px 16px #000000,10px 16px color-mix(in srgb, #f2c019, white 55%),12px 16px #f2c019,14px 16px #f2c019,16px 16px #000000,18px 16px #000000,20px 16px #f2c019,22px 16px #f2c019,24px 16px #ff6f00,26px 16px #000000,8px 18px #000000,10px 18px color-mix(in srgb, #f2c019, white 55%),12px 18px #f2c019,14px 18px #f2c019,16px 18px #000000,18px 18px #000000,20px 18px #f2c019,22px 18px #f2c019,24px 18px #ff6f00,26px 18px #000000,6px 20px #000000,8px 20px color-mix(in srgb, #f2c019, white 55%),10px 20px #f2c019,12px 20px #f2c019,14px 20px #f2c019,16px 20px #000000,18px 20px #000000,20px 20px #f2c019,22px 20px #f2c019,24px 20px #f2c019,26px 20px #ff6f00,28px 20px #000000,6px 22px #000000,8px 22px color-mix(in srgb, #f2c019, white 55%),10px 22px #f2c019,12px 22px #f2c019,14px 22px #f2c019,16px 22px #000000,18px 22px #000000,20px 22px #f2c019,22px 22px #f2c019,24px 22px #f2c019,26px 22px #ff6f00,28px 22px #000000,4px 24px #000000,6px 24px color-mix(in srgb, #f2c019, white 55%),8px 24px #f2c019,10px 24px #f2c019,12px 24px #f2c019,14px 24px #f2c019,16px 24px #f2c019,18px 24px #f2c019,20px 24px #f2c019,22px 24px #f2c019,24px 24px #f2c019,26px 24px #f2c019,28px 24px #ff6f00,30px 24px #000000,4px 26px #000000,6px 26px color-mix(in srgb, #f2c019, white 55%),8px 26px #f2c019,10px 26px #f2c019,12px 26px #f2c019,14px 26px #f2c019,16px 26px #000000,18px 26px #000000,20px 26px #f2c019,22px 26px #f2c019,24px 26px #f2c019,26px 26px #f2c019,28px 26px #ff6f00,30px 26px #000000,2px 28px #000000,4px 28px color-mix(in srgb, #f2c019, white 55%),6px 28px #f2c019,8px 28px #f2c019,10px 28px #f2c019,12px 28px #f2c019,14px 28px #f2c019,16px 28px #000000,18px 28px #000000,20px 28px #f2c019,22px 28px #f2c019,24px 28px #f2c019,26px 28px #f2c019,28px 28px #f2c019,30px 28px #ff6f00,32px 28px #000000,2px 30px #000000,4px 30px color-mix(in srgb, #f2c019, white 55%),6px 30px #f2c019,8px 30px #f2c019,10px 30px #f2c019,12px 30px #f2c019,14px 30px #f2c019,16px 30px #f2c019,18px 30px #f2c019,20px 30px #f2c019,22px 30px #f2c019,24px 30px #ff6f00,26px 30px #ff6f00,28px 30px #ff6f00,30px 30px #ff6f00,32px 30px #000000,4px 32px #000000,6px 32px #000000,8px 32px #000000,10px 32px #000000,12px 32px #000000,14px 32px #000000,16px 32px #000000,18px 32px #000000,20px 32px #000000,22px 32px #000000,24px 32px #000000,26px 32px #000000,28px 32px #000000,30px 32px #000000;;
}
...
.snes-button::before, .snes-button::after {
  content: "";
  position: absolute;
  display: block;
  z-index: 0;
...
.snes-list li::before {
  ...
  top: calc(-3em / 9);
  color: #f22561;
  margin: 0.42em 0.48em;
  content: "";
  width: 0.12em;
  height: 0.12em;
  box-shadow: 0.48em 0.12em #000000,0.6em 0.12em #000000,0.72em 0.12em #000000,0.84em 0.12em #000000,0.36em 0.24em #000000,0.48em 0.24em color-mix(in srgb, currentColor, white 55%),0.6em 0.24em color-mix(in srgb, currentColor, white 55%),0.72em 0.24em color-mix(in srgb, currentColor, white 55%),0.84em 0.24em color-mix(in srgb, currentColor, white 55%),0.96em 0.24em #000000,0.24em 0.36em #000000,0.36em 0.36em color-mix(in srgb, currentColor, white 55%),0.48em 0.36em #ffffff,0.6em 0.36em currentColor,0.72em 0.36em currentColor,0.84em 0.36em currentColor,0.96em 0.36em color-mix(in srgb, currentColor, white 55%),1.08em 0.36em #000000,0.12em 0.48em #000000,0.24em 0.48em color-mix(in srgb, currentColor, white 55%),0.36em 0.48em #ffffff,0.48em 0.48em currentColor,0.6em 0.48em currentColor,0.72em 0.48em currentColor,0.84em 0.48em currentColor,0.96em 0.48em currentColor,1.08em 0.48em color-mix(in srgb, currentColor, white 55%),1.2em 0.48em #000000,0.12em 0.6em #000000,0.24em 0.6em currentColor,0.36em 0.6em currentColor,0.48em 0.6em currentColor,0.6em 0.6em currentColor,0.72em 0.6em currentColor,0.84em 0.6em currentColor,0.96em 0.6em currentColor,1.08em 0.6em currentColor,1.2em 0.6em #000000,0.12em 0.72em #000000,0.24em 0.72em color-mix(in srgb, currentColor, black 70%),0.36em 0.72em currentColor,0.48em 0.72em currentColor,0.6em 0.72em currentColor,0.72em 0.72em currentColor,0.84em 0.72em currentColor,0.96em 0.72em currentColor,1.08em 0.72em color-mix(in srgb, currentColor, black 70%),1.2em 0.72em #000000,0.24em 0.84em #000000,0.36em 0.84em currentColor,0.48em 0.84em currentColor,0.6em 0.84em currentColor,0.72em 0.84em currentColor,0.84em 0.84em currentColor,0.96em 0.84em currentColor,1.08em 0.84em #000000,0.36em 0.96em #000000,0.48em 0.96em color-mix(in srgb, currentColor, black 70%),0.6em 0.96em color-mix(in srgb, currentColor, black 70%),0.72em 0.96em color-mix(in srgb, currentColor, black 70%),0.84em 0.96em color-mix(in srgb, currentColor, black 70%),0.96em 0.96em #000000,0.48em 1.08em #000000,0.6em 1.08em #000000,0.72em 1.08em #000000,0.84em 1.08em #000000;;
}
@media screen and (max-width: 992px) {
  .snes-list {
...
.snes-range::before, .snes-range::after {
  content: "";
  position: absolute;
  display: block;
  z-index: 0;
...
.snes-checkbox__item__content::before {
  ...
  width: 0.125em;
  height: 0.125em;
  box-shadow: 0.375em 0.25em #000000,0.5em 0.25em #000000,0.625em 0.25em #000000,0.75em 0.25em #000000,0.875em 0.25em #000000,1em 0.25em #000000,1.125em 0.25em #000000,1.25em 0.25em #000000,0.25em 0.375em #000000,1.375em 0.375em #000000,0.125em 0.5em #000000,1.5em 0.5em #000000,0.125em 0.625em #000000,1.5em 0.625em #000000,0.125em 0.75em #000000,1.5em 0.75em #000000,0.125em 0.875em #000000,1.5em 0.875em #000000,0.125em 1em #000000,1.5em 1em #000000,0.125em 1.125em #000000,1.5em 1.125em #000000,0.125em 1.25em #000000,1.5em 1.25em #000000,0.125em 1.375em #000000,1.5em 1.375em #000000,0.25em 1.5em #000000,1.375em 1.5em #000000,0.375em 1.625em #000000,0.5em 1.625em #000000,0.625em 1.625em #000000,0.75em 1.625em #000000,0.875em 1.625em #000000,1em 1.625em #000000,1.125em 1.625em #000000,1.25em 1.625em #000000;;
}
...
.snes-blockquote {
  ...
  text-align: center;
  color: #fff;
  background-color: color-mix(in srgb, #e5e5e5, black 55%);
  padding: 32px;
  border: solid;
  -o-border-image: var(--border-image);
     border-image: var(--border-image);
...
.snes-blockquote::before, .snes-blockquote::after {
  content: "";
  position: absolute;
  display: block;
  z-index: 0;
...
.snes-blockquote.has-plumber-bg {
  background-color: color-mix(in srgb, #f22561, black 55%);
}
.snes-blockquote.has-nature-bg {
  background-color: color-mix(in srgb, #4bb244, black 55%);
}
.snes-blockquote.has-sunshine-bg {
  background-color: color-mix(in srgb, #f2c019, black 55%);
}
.snes-blockquote.has-ocean-bg {
  background-color: color-mix(in srgb, #4eb6d9, black 55%);
}
.snes-blockquote.has-turquoise-bg {
  background-color: color-mix(in srgb, #40e0d0, black 55%);
}
.snes-blockquote.has-phantom-bg {
  background-color: color-mix(in srgb, #9b5de5, black 55%);
}
.snes-blockquote.has-rose-bg {
  background-color: color-mix(in srgb, #f784b2, black 55%);
}
.snes-blockquote.has-galaxy-bg {
  background-color: color-mix(in srgb, #5a7d9a, black 55%);
}
.snes-blockquote.has-ember-bg {
  background-color: color-mix(in srgb, #ff6f00, black 55%);
}
.text-plumber-color {
  color: #f22561;
}
